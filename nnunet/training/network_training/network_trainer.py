...
class NetworkTrainer(object):
    ...
    def load_pretrained_weights(self,fname):                                    
        ...
        print("model_dict", len(pretrained_dict.keys()))                            
                        
        fine_tune = True                                                        
        for key, _ in model_dict.items():                                       
            if ('conv_blocks' in key):
                print("model_dict[key].shape, pretrained_dict[key].shape   " , model_dict[key].shape, pretrained_dict[key].shape )    
                print("key in pretrained_dict", key in pretrained_dict)                              
